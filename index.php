    ...
    <header>
      <div class="section__container header__container">
        ...
        <div class="header__image">
          <img src="img/home1.png" alt="header" />
        </div>
      </div>
    </header>
    ...
    <section class="section__container sale__container">
      ...
      <div class="sale__grid">
        <div class="sale__card">
          <img src="img/produit/pro1.jpg" alt="sale" />
          <div class="sale__content">
            <p class="sale__subtitle"> WOMAN BLAZERS </p>
        ...
        <div class="sale__card">
          <img src="img/produit/pro2.jpg" alt="sale" />
          <div class="sale__content">
        ...
        <div class="sale__card">
          <img src="img/produit/pro3.jpg" alt="sale" />
          <div class="sale__content">
    ...
    <section class="section__container musthave__container">
      ...
      <div class="musthave__grid">
        <div class="musthave__card">
          ...
          <h4>Wide Leg & Flard Brown Pants<</h4>
        ...
        <div class="musthave__card">
          <img src="img/img5.jpg" alt="must have" />
          <h4>Sweetheart Neck Flounce Sleeve Lace Up Corset Dress</h4>
          <p><del>$45.00</del> $75.00</p>
        </div>
        <div class="musthave__card">
          <img src="img/img6.jpg" alt="must have"/>
          <h4>Good Blazer To wear for Jop</h4>
          <p><del>$45.00</del> $75.00</p>
        </div>
        <div class="musthave__card">
          <img src="img/img10.jpg" alt="must have" />
          <h4>Coral fabric belt bag</h4>
          <p><del>$45.00</del> $75.00</p>
        </div>
        <div class="musthave__card">
          <img src="img/img1.jpg" alt="must have" />
          <h4>Piggy skater slogan T-shirt</h4>
          <p><del>$45.00</del> $75.00</p>
        </div>
        <div class="musthave__card">
          <img src="img/img9" alt="must have" />
          <h4>White platform boots</h4>
          <p><del>$45.00</del> $75.00</p>
        </div>
        <div class="musthave__card">
          <img src="img/img8.jpg" alt="must have" />
          <h4>Sweater vest with sleeves</h4>
          <p><del>$45.00</del> $75.00</p>
        </div>
        <div class="musthave__card">
          <img src="img/imgg2.jpg" alt="must have" />
          <h4>Letter  Print Sweatshirt</h4>
          <p><del>$45.00</del> $75.00</p>
        </div>
        <div class="musthave__card">
          <img src="img/img2.jpg" alt="must have" />
          <h4>Avtast Spring Cotton Pullover Green Sweatshirts </h4>
          <p><del>$45.00</del> $75.00</p>
        </div>
        <div class="musthave__card">
          <img src="img/img12.jpg" alt="must have" />
          <h4>Green Long SleeVe Drawstring Hoodies With Kangaroo Pocket</h4>
          <p><del>$45.00</del> $75.00</p>
        </div>
        <div class="musthave__card">
          <img src="img/imgg3" alt="must have" />
          <h4>High Neck Drop Shoulder Sweater</h4>
          <p><del>$45.00</del> $75.00</p>
        </div>
      </div>
    </section>
