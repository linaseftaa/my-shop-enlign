<?php
  if(isset($_POST['btn-ajouter'])){
      ...
      if(!empty($titre) && !empty($description)){
          ...
          $req1 = mysqli_query($con, "SELECT titre ,descrip FROM prod WHERE titre ='$titre' AND descrip = '$description'");
          if(mysqli_num_rows($req1) > 0) {
              ...
              if(isset($_FILES['image'])){
                  ...
                  if($deplacer_image){
                      ...
                      $req2 = mysqli_query($con,"INSERT INTO prod VALUES (NULL,'$titre','$description','$nouveau_nom_img')") ;
                       if($req2){
